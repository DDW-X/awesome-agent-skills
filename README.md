...
[![Build Status](https://img.shields.io/badge/Build-Passing-2ea44f?style=for-the-badge&logo=githubactions)](https://github.com/DDW-X)
[![Agent Skills Spec](https://img.shields.io/badge/Agent_Skills-2026_Standard-705dcf?style=for-the-badge&logo=openai)](https://github.com/DDW-X)
[![Cross-IDE Support](https://img.shields.io/badge/IDE-Antigravity_|_Cursor_|_Claude_|_Copilot-0052CC?style=for-the-badge&logo=visualstudiocode)](https://github.com/DDW-X)
[![Total Skills](https://img.shields.io/badge/Skills-35_Configured-ff69b4?style=for-the-badge)](https://github.com/DDW-X)
[![Data Integrity](https://img.shields.io/badge/Data_Integrity-100%25_Verified-00b4d8?style=for-the-badge)](https://github.com/DDW-X)
[![Token Optimization](https://img.shields.io/badge/Context_Savings-98.5%25-green?style=for-the-badge)](https://github.com/DDW-X)
[![License](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)](LICENSE)

---

### <img src="assets/icons/globe.svg" width="18" height="18" align="absmiddle" alt="globe" /> Transcending Raw Prompt Leaks into Autonomous, Token-Efficient Agentic Intelligence
...
## <img src="assets/icons/manifesto.svg" width="20" height="20" align="absmiddle" alt="manifesto" /> Manifesto & Core Vision
...
## <img src="assets/icons/toc.svg" width="20" height="20" align="absmiddle" alt="toc" /> Table of Contents
...
## <img src="assets/icons/architecture.svg" width="20" height="20" align="absmiddle" alt="architecture" /> System Architecture & Progressive Disclosure

<details>
<summary><b><img src="assets/icons/expand.svg" width="16" height="16" align="absmiddle" alt="expand" /> Click to expand: System Architecture & Progressive Disclosure Pipeline</b></summary>
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1e293b', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#3b82f6', 'lineColor': '#38bdf8', 'textColor': '#ffffff', 'nodeBorder': '#3b82f6', 'clusterBkg': '#0f172a', 'clusterBorder': '#64748b' }}}%%
flowchart TD
    subgraph Ingestion["Phase 1: Raw Leak Extraction"]
        RawFiles["system_prompts_leaks/"] --> Aggregator["Model Aggregation Engine"]
    end

    subgraph Disclosure["Phase 2: Progressive Disclosure Architecture"]
        Aggregator --> L1["Level 1: YAML Metadata\nName & Description\n~50-100 Tokens | Always Active"]
        Aggregator --> L2["Level 2: SKILL.md Core Rules\n< 500 Lines (~5k Tokens)\nLoaded on Intent Trigger"]
        Aggregator --> L3["Level 3: references/*.md Raw Leaks\nUnlimited Size\nRead On-Demand via Tools"]
    end

    subgraph Runtime["Phase 3: Intent-Driven Agent Execution"]
        UserQuery["Developer Request"] --> Router{"Agent Intent Router"}
        L1 --> Router
        Router -->|"Query Matches Keywords"| L2
        L2 -->|"Deep Context Needed"| L3
    end

    style L1 fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#ffffff
    style L2 fill:#0f172a,stroke:#10b981,stroke-width:2px,color:#ffffff
    style L3 fill:#0f172a,stroke:#8b5cf6,stroke-width:2px,color:#ffffff
    style RawFiles fill:#0f172a,stroke:#f59e0b,stroke-width:2px,color:#ffffff
    style Aggregator fill:#0f172a,stroke:#64748b,stroke-width:2px,color:#ffffff
    style UserQuery fill:#0f172a,stroke:#ec4899,stroke-width:2px,color:#ffffff
    style Router fill:#0f172a,stroke:#06b6d4,stroke-width:2px,color:#ffffff
```
...
## <img src="assets/icons/routing.svg" width="20" height="20" align="absmiddle" alt="routing" /> Multi-IDE Execution & Routing Flow

The sequence diagram below details how `<DDW-X>` skills route incoming developer requests across different IDE environments:

```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1e293b', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#3b82f6', 'lineColor': '#38bdf8', 'textColor': '#ffffff', 'actorBkg': '#1e293b', 'actorTextColor': '#ffffff', 'actorLineColor': '#38bdf8', 'signalColor': '#38bdf8', 'labelBoxBkgColor': '#0f172a', 'labelBoxFrameColor': '#3b82f6', 'labelTextColor': '#ffffff' }}}%%
sequenceDiagram
    autonumber
    actor Dev as Developer
    participant IDE as IDE Router (Antigravity/Cursor/Claude)
    participant L1 as Level 1 Metadata Index
    participant L2 as Level 2 SKILL.md
    participant L3 as Level 3 references/*.md
    participant LLM as LLM Execution Engine

    Dev->>IDE: "Audit this REST API for authentication vulnerabilities"
    IDE->>L1: Scan Level 1 trigger descriptions
    L1-->>IDE: Match found: '<DDW-X> claude-fable-5' & '<DDW-X> Master: Cybersecurity'
    IDE->>L2: Load Level 2 SKILL.md core checklist & patterns (< 5k tokens)
    L2->>LLM: Inject structured security operational rules
    opt Deep Protocol Analysis
        LLM->>L3: Read references/claude-fable-5.md on-demand via view_file
        L3-->>LLM: Return exact threat model & payload disassembly guidelines
    end
    LLM-->>Dev: Return verified Security Audit & Diffs
```

---

## <img src="assets/icons/mindmap.svg" width="20" height="20" align="absmiddle" alt="mindmap" /> Full Skill Taxonomy Mindmap

<details>
<summary><b><img src="assets/icons/expand.svg" width="16" height="16" align="absmiddle" alt="expand" /> Click to expand: Full Skill Taxonomy Mindmap</b></summary>
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1e293b', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#3b82f6', 'lineColor': '#38bdf8', 'textColor': '#ffffff', 'clusterBkg': '#0f172a', 'clusterBorder': '#475569' }}}%%
flowchart LR
    Root["<DDW-X> Knowledge Base"] --> Meta["Meta Generation"]
    Root --> Anthropic["Anthropic Family"]
    Root --> OpenAI["OpenAI Family"]
    Root --> Google["Google Family"]
    Root --> OpenP["Open & Partner Ecosystems"]
    Root --> Master["Domain Master Skills"]

    Meta --> M1["Skill-Architect-Meta"]

    Anthropic --> A1["claude-fable-5"]
    Anthropic --> A2["claude-opus"]
    Anthropic --> A3["claude-sonnet"]
    Anthropic --> A4["claude-code-engine"]
    Anthropic --> A5["claude-integrations"]

    OpenAI --> O1["openai-gpt4o"]
    OpenAI --> O2["openai-gpt5"]
    OpenAI --> O3["openai-o-series"]
    OpenAI --> O4["openai-codex-engine"]
    OpenAI --> O5["openai-chatgpt-tools"]

    Google --> G1["google-gemini-2"]
    Google --> G2["google-gemini-3"]
    Google --> G3["google-antigravity-suite"]
    Google --> G4["google-workspace-integrations"]

    OpenP --> P1["cursor-engine"]
    OpenP --> P2["deepseek-engine"]
    OpenP --> P3["microsoft-copilot-suite"]
    OpenP --> P4["xai-grok"]
    OpenP --> P5["qwen-engine"]
    OpenP --> P6["mistral-engine"]
    OpenP --> P7["meta-llama"]
    OpenP --> P8["kimi-engine"]
    OpenP --> P9["perplexity-suite"]
    OpenP --> P10["misc-agentic-tools"]

    Master --> MS1["Master: Cybersecurity & SecOps"]
    Master --> MS2["Master: Low-Level Systems"]
    Master --> MS3["Master: Full-Stack Architecture"]

    style Root fill:#0f172a,stroke:#ef4444,stroke-width:2px,color:#ffffff
    style Meta fill:#0f172a,stroke:#64748b,stroke-width:1px,color:#ffffff
    style Anthropic fill:#0f172a,stroke:#f97316,stroke-width:1px,color:#ffffff
    style OpenAI fill:#0f172a,stroke:#10b981,stroke-width:1px,color:#ffffff
    style Google fill:#0f172a,stroke:#3b82f6,stroke-width:1px,color:#ffffff
    style OpenP fill:#0f172a,stroke:#8b5cf6,stroke-width:1px,color:#ffffff
    style Master fill:#0f172a,stroke:#eab308,stroke-width:2px,color:#ffffff
```
...
## <img src="assets/icons/economics.svg" width="20" height="20" align="absmiddle" alt="economics" /> Token Economics & Performance Math
...
## <img src="assets/icons/security.svg" width="20" height="20" align="absmiddle" alt="security" /> Security & Sandboxing Framework

<details>
<summary><b><img src="assets/icons/expand.svg" width="16" height="16" align="absmiddle" alt="expand" /> Click to expand: Security & Sandboxing Framework</b></summary>
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1e293b', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#ef4444', 'lineColor': '#f87171', 'textColor': '#ffffff', 'clusterBkg': '#0f172a', 'clusterBorder': '#991b1b' }}}%%
flowchart TD
    Payload["Incoming Security Payload / Vulnerability Review"] --> StaticAnalysis["Step 1: AST & Regex Static Analysis"]
    StaticAnalysis --> RiskEval{"Execution Safety Check"}
    RiskEval -->|"High Risk Destructive Action"| Sandbox["Step 2: Isolated Docker Container\nNetwork Namespace: NONE"]
    RiskEval -->|"Low Risk Code Inspection"| LocalInspect["Step 3: In-Memory Static Disassembly"]
    Sandbox --> Verification["Step 4: Differential Result Verification"]
    LocalInspect --> Verification
    Verification --> Output["Return Sanitized Remediation Plan"]

    style StaticAnalysis fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#ffffff
    style RiskEval fill:#0f172a,stroke:#f59e0b,stroke-width:2px,color:#ffffff
    style Sandbox fill:#0f172a,stroke:#ef4444,stroke-width:2px,color:#ffffff
    style LocalInspect fill:#0f172a,stroke:#10b981,stroke-width:2px,color:#ffffff
    style Output fill:#0f172a,stroke:#06b6d4,stroke-width:2px,color:#ffffff
```
...
## <img src="assets/icons/matrix.svg" width="20" height="20" align="absmiddle" alt="matrix" /> Feature Matrix: `<DDW-X>` vs Copy-Pasting
...
## <img src="assets/icons/arsenal.svg" width="20" height="20" align="absmiddle" alt="arsenal" /> The Arsenal: 25 Ecosystem Model Skills
...
## <img src="assets/icons/master-skills.svg" width="20" height="20" align="absmiddle" alt="masters" /> Domain-Specific Master Skills
...
### <img src="assets/icons/lock.svg" width="18" height="18" align="absmiddle" alt="lock" /> `<DDW-X> Master: Cybersecurity & SecOps`
...
### <img src="assets/icons/cpu.svg" width="18" height="18" align="absmiddle" alt="cpu" /> `<DDW-X> Master: Low-Level Systems Programming`
...
### <img src="assets/icons/network.svg" width="18" height="18" align="absmiddle" alt="network" /> `<DDW-X> Master: Advanced Full-Stack Architecture`
...
### <img src="assets/icons/workflow.svg" width="18" height="18" align="absmiddle" alt="workflow" /> `<DDW-X> Master: Workflow Orchestration & n8n`
...
### <img src="assets/icons/mcp.svg" width="18" height="18" align="absmiddle" alt="mcp" /> `<DDW-X> Master: MCP & n8n Agentic Orchestration`
...
## <img src="assets/icons/cyber-division.svg" width="20" height="20" align="absmiddle" alt="cyber-division" /> Cybersecurity Operations (CS) Division
...
### <img src="assets/icons/lock.svg" width="18" height="18" align="absmiddle" alt="lock" /> 1. [`Skills-CS/Advanced Reverse Engineering & Ghidra MCP.md`](file:///c:/Users/sorena/Desktop/ddw-x%20clone/skillssssssssssssssssssssssss/Skills-CS/Advanced%20Reverse%20Engineering%20&%20Ghidra%20MCP.md)
...
### <img src="assets/icons/audit.svg" width="18" height="18" align="absmiddle" alt="audit" /> 2. [`Skills-CS/Agentic Malware Analysis & Triage.md`](file:///c:/Users/sorena/Desktop/ddw-x%20clone/skillssssssssssssssssssssssss/Skills-CS/Agentic%20Malware%20Analysis%20&%20Triage.md)
...
### <img src="assets/icons/security.svg" width="18" height="18" align="absmiddle" alt="security" /> 3. [`Skills-CS/IDE Security & Code Auditing Architect.md`](file:///c:/Users/sorena/Desktop/ddw-x%20clone/skillssssssssssssssssssssssss/Skills-CS/IDE%20Security%20&%20Code%20Auditing%20Architect.md)
...
### <img src="assets/icons/network.svg" width="18" height="18" align="absmiddle" alt="network" /> 4. [`Skills-CS/Detection Engineering & Threat Hunting.md`](file:///c:/Users/sorena/Desktop/ddw-x%20clone/skillssssssssssssssssssssssss/Skills-CS/Detection%20Engineering%20&%20Threat%20Hunting.md)
...
### <img src="assets/icons/cpu.svg" width="18" height="18" align="absmiddle" alt="cpu" /> 5. [`Skills-CS/AI Safety & LLM Red Teaming Defense.md`](file:///c:/Users/sorena/Desktop/ddw-x%20clone/skillssssssssssssssssssssssss/Skills-CS/AI%20Safety%20&%20LLM%20Red%20Teaming%20Defense.md)
...
## <img src="assets/icons/install.svg" width="20" height="20" align="absmiddle" alt="install" /> Installation & Multi-IDE CLI Guide
...
## <img src="assets/icons/audit.svg" width="20" height="20" align="absmiddle" alt="audit" /> Automated Verification & Quality Audit Report
...
## <img src="assets/icons/roadmap.svg" width="20" height="20" align="absmiddle" alt="roadmap" /> Roadmap & Future Milestones
...
## <img src="assets/icons/credits.svg" width="20" height="20" align="absmiddle" alt="credits" /> Acknowledgements & Credits
...
## <img src="assets/icons/creator.svg" width="20" height="20" align="absmiddle" alt="creator" /> Creator Hub & Contact Information
...
|---|---|---|
| **GitHub Organization** | `DDW-X` | [![GitHub](https://img.shields.io/badge/GitHub-DDW--X-181717?style=for-the-badge&logo=github)](https://github.com/DDW-X) |
| **Telegram Channel** | `CONTROLSERVER` | [![Telegram Channel](https://img.shields.io/badge/Telegram-CONTROLSERVER-26A5E4?style=for-the-badge&logo=telegram)](https://t.me/CONTROLSERVER) |
| **Telegram Direct (PV)** | `@DDW_X` | [![Telegram Direct](https://img.shields.io/badge/Telegram-@DDW__X-26A5E4?style=for-the-badge&logo=telegram)](https://t.me/DDW_X) |
| **Official Business Email** | `DDW.X.OFFICIAL@gmail.com` | [![Email](https://img.shields.io/badge/Email-DDW.X.OFFICIAL-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:DDW.X.OFFICIAL@gmail.com) |

</div>

---

## <img src="assets/icons/license.svg" width="20" height="20" align="absmiddle" alt="license" /> Contributing & License
